...
var MainScene = /** @class */ (function (_super) {
    ...
    function MainScene(param) {
        ...
        _this.loaded.add(function () {
            ...
            //ステージ
            uiBase.append(new g.Sprite({ scene: _this, src: _this.assets["score"], x: 485, y: 45, height: 32, srcY: 32 }));
            var stage = 0;
            ...
            //スコア
            uiBase.append(new g.Sprite({ scene: _this, src: _this.assets["score"], x: 485, y: 85, height: 32 }));
            var score = 0;
