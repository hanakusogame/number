...
export class MainScene extends g.Scene {
	...
	constructor(param: g.SceneParameterObject) {
		param.assetIds = [
			...
			"waku", "clear", "waku","wakuf", "panel","number",
		...
		this.loaded.add(() => {
			...
			//ステージ
			uiBase.append(new g.Sprite({ scene: this, src: this.assets["score"], x: 485, y: 45, height: 32, srcY: 32 }));
			let stage = 0;
			...
			//スコア
			uiBase.append(new g.Sprite({ scene: this, src: this.assets["score"], x: 485, y: 85, height: 32 }));
			let score = 0;
